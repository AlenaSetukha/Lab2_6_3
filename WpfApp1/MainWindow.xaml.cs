    ...
    public partial class MainWindow : Window
    {
        ...
        private void MeasuredData_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            try
            {
                ...
                v_data.char_data.AddSeries(v_data.s_data.md.nodes_non_uniform, v_data.s_data.md.res_f, "Measured", 0);
            }
        ...
        private void Splines_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            try
            {
                ...
                if (ret == 0)
                {
                    ...
                    // Add to plot
                    double[] points = new double[v_data.s_data.md.n_uniform];
                    for (int i = 0; i < v_data.s_data.md.n_uniform; i++)
                    {
                        points[i] = v_data.s_data.md.a + i * (v_data.s_data.md.b - v_data.s_data.md.a)
                            / (v_data.s_data.md.n_uniform - 1);
                    }
